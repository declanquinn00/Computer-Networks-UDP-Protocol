 ...
 *
 */
public class ClientOG extends Node {
	 ...
	 */
	ClientOG(String dstHost, int dstPort, int srcPort) {
		try {
	...
	public static void main(String[] args) {
		try {
			(new ClientOG(DEFAULT_DST_NODE, DEFAULT_DST_PORT, DEFAULT_SRC_PORT)).start();
