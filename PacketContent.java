...
public abstract class PacketContent {
	...
	public static final int DATAPACKET= 1000;
	public static final int MESSAGEPACKET= 10000;
	int type= 0;
	...
	public static PacketContent fromDatagramPacket(DatagramPacket packet) {
		...
		try {
			...
			case FILEINFO:
				...
				break;
			case MESSAGEPACKET:
				content= new MessagePacketContent(oin);
				break;
			case DATAPACKET:
				content= new DataPacketContent(oin);
				break;
			default:
				content= null;
				break;
